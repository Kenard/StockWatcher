...
public class StockWatcher implements EntryPoint {
	...
	private void loadStockWatcher() {
		...
		// Put together the Add Stock panel
		...
		// Associate the Main panel with the RootPanel stockList on the HTML page
		RootPanel.get("stockList").add(mainPanel);
		
		// Move cursor focus to the input box
		newSymbolTextBox.setFocus(true);
		
		// Set up the timer to refresh the list automatically
	...
	private void displayStock(final String symbol) {
	    ...
	    // Add a button to delete this stock from the table
	    ...
	    // Get the stock prices and update them
	    refreshWatchList();
	}
